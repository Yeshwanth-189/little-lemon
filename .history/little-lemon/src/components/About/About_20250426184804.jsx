    ...
    <section className="about-grid">
      ...
      <div className="about-text">
        ...
        <p>
          ...
          recipes, and the welcoming spirit that defines our culture. Whether
          you're enjoying a casual meal with friends or celebrating a special
          occasion, Little Lemon offers an unforgettable dining experience
          infused with warmth, flavor, and tradition.
        </p>
      </div>
